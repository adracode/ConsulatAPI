...
public class SeenCommand extends ConsulatCommand {
    ...
    public SeenCommand(){
        super(ConsulatAPI.getConsulatAPI(), "seen");
    ...
    public void onCommand(@NotNull ConsulatPlayer sender, @NotNull String[] args){
        ...
        Bukkit.getScheduler().runTaskAsynchronously(ConsulatAPI.getConsulatAPI(), () -> {
            try {
                ...
                PreparedStatement preparedStatement = ConsulatAPI.getDatabase().prepareStatement("SELECT * FROM connections INNER JOIN players ON connections.player_id = players.id WHERE players.player_name = ? ORDER BY connections.id DESC LIMIT 5 ");
