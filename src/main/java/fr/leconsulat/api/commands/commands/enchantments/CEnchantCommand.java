package fr.leconsulat.api.commands.commands.enchantments;
...
public class CEnchantCommand extends ConsulatCommand implements ConsoleUsable {
    ...
    public CEnchantCommand(){
        super(ConsulatAPI.getConsulatAPI(), "cenchant");
    ...
    public void onConsoleUse(CommandSender sender, String[] args){
        ...
        ConsulatPlayer player = CPlayerManager.getInstance().getConsulatPlayer(args[2]);
        if(player == null){
