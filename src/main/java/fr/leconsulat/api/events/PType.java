...
public enum PType {
    ...
    BARREL(PCategory.ACCESS_CONTENT),
    BEACON(PCategory.ACCESS_CONTENT),
    BELL(PCategory.OTHER),
    BED(PCategory.OTHER),
    SHULKER_BOX(PCategory.ACCESS_CONTENT),
    BLAST_FURNACE(PCategory.ACCESS_CONTENT),
    BREWING_STAND(PCategory.ACCESS_CONTENT),
    ...
    CHEST(PCategory.ACCESS_CONTENT),
    ...
    DISPENSER(PCategory.ACCESS_CONTENT),
    DRAGON_EGG(PCategory.OTHER),
    DROPPER(PCategory.ACCESS_CONTENT),
    ...
    FURNACE(PCategory.ACCESS_CONTENT),
    GRINDSTONE(PCategory.OPEN_GUI),
    HOPPER(PCategory.ACCESS_CONTENT),
    JUKEBOX(PCategory.ACCESS_CONTENT),
    LECTERN(PCategory.ACCESS_CONTENT),
    ...
    SMOKER(PCategory.ACCESS_CONTENT),
